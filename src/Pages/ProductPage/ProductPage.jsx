...
debugger
 ...
 const tableRows = tableData.map((element,index) => {
  ...
  const productsArray = (props.products.filter((element,index) => index < 5 )).map((element, i) => {
    return( <ProductItem 
      productData= {element} 
      ...
      <div className={styles.product_page}>
        ...
        <div className={styles.description_block}>
          ...
          <div className={styles.rating_block}>
            <Rating name="read-only" value={props.productData.rating ? props.productData.rating : 0} readOnly />
            <span className={styles.rating_span}>(1 customer review)</span>
          </div>
            <ImageCarousel/>
          <p className={styles.description}>
            {props.productData 
             ? props.productData.subtitle
             : "subtitle"
            }
          </p>
