...
export const API = {
  ...
  async getCategoryProducts(
    ...
    return await instance
      .get(
        `/products?categoryId=${categoryId}&bestSelling=${bestSelling}&bestFromFarmers=${bestFromFarmers}&page=${page}`
      )
      .then((response) => {
        return response.data;
      });
  ...
  async getProducts(
    ...
    return await instance
      .get(
        `products?limit=${limit}&bestFromFarmers=${bestFromFarmers}&bestSelling=${bestSelling}&page=${page}`
      )
      .then((response) => {
        return response.data;
      });
