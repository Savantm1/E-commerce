...
const BasketItem = (props) => {
  ...
  const changeCount = (c) => {
    ...
    dispatch(changeCountOnCart(data));
  };

  const deleteProduct = () => {
    dispatch(deleteProductFromCart(props.productData.id));
    props.toastDelete();
  };
      ...
      <div className="basket_item">
        <div className="basket_item__info_block">
          ...
          <div className="basket_item__params_block">
            <Title margin="0px">{props.productData.productName}</Title>
            <p className="basket_item__parameter">
              Farm: <span>Tharamist Farm</span>
            </p>
            <p className="basket_item__parameter">
        ...
        <div className="buttons_block">
          ...
          <p className="remove" onClick={deleteProduct}>
            <img className="remove_img" src={close} alt="close" />
            Remove
          </p>
        </div>
        <div className="price_block">
          <Rating value={props.productData.rating} readOnly={true} />
          <span className="price">{props.productData.price} USD</span>
        </div>
        <input
