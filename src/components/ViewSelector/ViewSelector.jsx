    ...
    return (
        <div className="view_selector">
            <div className="veiwselector_block">
                <input  id="grid" type="radio" name="viewselector" defaultChecked value="Grid view"/>
                <label className="grid" htmlFor="grid"  onClick ={viewFunc}> Grid view </label>
                {/* <div className="checkbox-shadow"></div> */}
            </div>
            <div className="veiwselector_block">
                <input  id="inline" type="radio" name="viewselector" value="list view"/>
                <label className="inline" htmlFor="inline" onClick ={viewFunc}> List view </label>
                {/* <div className="checkbox-shadow"></div> */}
            </div>
